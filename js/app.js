import { initializeApp } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";
    ...
    const voltarParaInicioOriginal = window.voltarParaInicio;
    ...
    function criarCardPost(post) {
      ...
      card.innerHTML = `
        ...
        <div class="post-actions-row">
          <button disabled>❤️ Curtir (${post.curtidas?.length || 0})</button>
          <button disabled>💬 Comentários (${post.comentarios?.length || 0})</button>
          <button disabled>📤 Compartilhar</button>
        </div>
      `;
