import { initializeApp } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";
    ...
    function renderizarProfilePosts() {
      ...
      const meusPosts = postsCache.filter((post) => post.autorId === usuarioAtual.uid);
      ...
      if (meusPosts.length === 0) {
        profilePosts.innerHTML = `
          <div class="panel feed-empty">
            ...
            <h2>Nenhuma publicação no perfil</h2>
            <p>Publique algo para aparecer na sua linha do tempo.</p>
          </div>
        `;
        return;
      }
    ...
    function renderizarComentariosLista(container, comentarios) {
      ...
      comentarios.forEach((comentario) => {
        ...
        item.innerHTML = `
          <img src="${comentario.foto || placeholderFoto}" alt="Foto de ${comentario.nome || "usuário"}" />
